...
def combustion(Compositions):
    ...
    Selec=70 # Selectivity for the combustion, it means 70% of the fuel is burned completely
    O2excess=0.01 # 10% of excess of oxygen
    ...
    # Incomplete combustion generating CO, H2O, CO2 and C
    ...
    # Computing airflow with 10% of excess of oxygen
    total_oxygen=Oxyg_methane+Oxyg_ethane+Oxyg_ethene+Oxyg_propane+Oxyg_buthane
    ...
    CO2_methane=XMethane*Fuel_flow*Selec/100*Perc/100
    CO2_ethane=2*XEthane*Fuel_flow*Selec/100*Perc/100
    CO2_ethene=2*XEthene*Fuel_flow*Selec/100*Perc/100
    CO2_propane=3*XPropane*Fuel_flow*Selec/100*Perc/100
    CO2_buthane=4*XButhane*Fuel_flow*Selec/100*Perc/100

    # Computing CO generated from incomplete combustion
    CO_methane=XMethane*Fuel_flow*(1-Selec/100)*Perc/100
    CO_ethane=2*XEthane*Fuel_flow*(1-Selec/100)*Perc/100
    CO_ethene=2*XEthene*Fuel_flow*(1-Selec/100)*Perc/100
    CO_propane=3*XPropane*Fuel_flow*(1-Selec/100)*Perc/100
    CO_buthane=4*XButhane*Fuel_flow*(1-Selec/100)*Perc/100

    # Computing the amount of water generated from the combustion
    H2O_methane=2*XMethane*Fuel_flow*Selec/100*Perc/100
    H2O_ethane=3*XEthane*Fuel_flow*Selec/100*Perc/100
    H2O_ethene=2*XEthene*Fuel_flow*Selec/100*Perc/100
    H2O_propane=4*XPropane*Fuel_flow*Selec/100*Perc/100
    H2O_buthane=5*XButhane*Fuel_flow*Selec/100*Perc/100

    # Computing the amount of water generated from the incomplete combustion
    H2O_methane_I=2*XMethane*Fuel_flow*(1-Selec/100)*Perc/100
    H2O_ethane_I=3*XEthane*Fuel_flow*(1-Selec/100)*Perc/100
    H2O_ethene_I=2*XEthene*Fuel_flow*(1-Selec/100)*Perc/100
    H2O_propane_I=4*XPropane*Fuel_flow*(1-Selec/100)*Perc/100
    H2O_buthane_I=5*XButhane*Fuel_flow*(1-Selec/100)*Perc/100

    # Computing the amount of water generated from the combustion of hydrogen
    H2O_hydrogen=Hydrogen_flow*Perc/100

    # Computing all flows
    Oxyg_consum=(Selec/100*(total_oxygen)+total_oxygen_I*(1-Selec/100)+Oxyg_hydrogen)*Perc/100
    ...
    #Nitrogen
    N2_outlet=Fuel_flow*XN2 +Air_flow*(1-Oxy_fraction)
    #CO
    ...
    Total_outlet=Methane_outlet+Ethane_outlet+Ethene_outlet+Propane_outlet+Buthane_outlet+Oxyg_outlet+N2_outlet+CO_outlet+CO2_outlet+H2O_outlet+H2_outlet
